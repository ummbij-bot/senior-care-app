...
do $$
declare
  senior_id uuid := uuid_generate_v4();
  guardian_id uuid := uuid_generate_v4();
  med_bp_id uuid := uuid_generate_v4();
  med_sugar_id uuid := uuid_generate_v4();
  med_vitamin_id uuid := uuid_generate_v4();
begin
  -- 시니어 프로필
